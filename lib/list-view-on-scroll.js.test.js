...
function listViewOnScroll(options){
	...
	function _init() {
		...
		console.log(options.dom_section)
		el = document.getElementById( options.el ) 

		sections = Array.prototype.slice.call( el.querySelectorAll( options.dom_section ) );
	...
	function _render(callback){
		console.log(options)
		var renderedHTML = ejs.render(options.templateHtml,options.listViewData);
		document.getElementById(options.renderDom).innerHTML = renderedHTML;
		// _init();
